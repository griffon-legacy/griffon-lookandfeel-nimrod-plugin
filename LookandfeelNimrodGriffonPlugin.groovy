 ...
 */
class LookandfeelNimrodGriffonPlugin {
    // the plugin version
    ...
    String source = 'https://github.com/griffon/griffon-lookandfeel-nimrod-plugin'
    ...
    String title = 'Pluggable Look & Feel based on NimROD'
    String description = '''
